...
export const CARDS = {
  ...
  warbanner: { id: 'warbanner', name: '戰旗軍魂', element: 'fire', class: 'support', attackStyle: 'melee', race: '不死', series: ['鐵壁'], base: { hp: 510, atk: 72, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', effects: [{ stat: 'atk', op: 'mul', value: 1.05 }] }] },
  ...
  cryptwidow: { id: 'cryptwidow', name: '墓穴寡婦', element: 'dark', class: 'dps', attackStyle: 'melee', race: '不死', series: ['影之眷屬'], base: { hp: 475, atk: 101, def: 38 }, growth: { hp: 52, atk: 12, def: 4 }, passives: [{ target: 'self', effects: [{ stat: 'critChance', op: 'add', valuePer: 0.03, perCountOf: { side: 'allies', where: { race: '不死' } } }] }] },
