...
export const CARDS = {
  ...
  emberguard: { id: 'emberguard', name: '熔岩守衛', element: 'fire', class: 'tank', attackStyle: 'melee', race: '機械', series: ['炎之眷屬', '守護者'], base: { hp: 700, atk: 60, def: 70 }, growth: { hp: 80, atk: 6, def: 7 }, passives: [{ target: 'allAllies', targetWhere: { series: '守護者' }, effects: [{ stat: 'def', op: 'mul', value: 1.15 }] }] },

  // ---- 風 ----
  zephyr: { id: 'zephyr', name: '疾風劍客', element: 'wind', class: 'dps', attackStyle: 'melee', race: '人', series: ['疾風'], base: { hp: 480, atk: 92, def: 36 }, growth: { hp: 52, atk: 11, def: 3 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.04, perCountOf: { side: 'allies', where: { series: '疾風' } } }] }] },
  galewind: { id: 'galewind', name: '風語祭司', element: 'wind', class: 'support', attackStyle: 'ranged', race: '人', series: ['疾風', '聖歌隊'], base: { hp: 500, atk: 70, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { element: 'wind' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.15 }] }] },

  // ---- 水 ----
  tidecaller: { id: 'tidecaller', name: '潮汐術士', element: 'water', class: 'dps', attackStyle: 'ranged', race: '人', series: ['潮汐'], base: { hp: 500, atk: 90, def: 40 }, growth: { hp: 55, atk: 10, def: 4 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.04, perCountOf: { side: 'allies', where: { element: 'water' } } }] }] },
  ...
  // ---- 光 ----
  seraph: { id: 'seraph', name: '聖光天使', element: 'light', class: 'support', attackStyle: 'ranged', race: '神', series: ['聖歌隊', '光輝'], base: { hp: 520, atk: 74, def: 46 }, growth: { hp: 58, atk: 8, def: 5 }, passives: [{ target: 'allAllies', targetWhere: { series: '聖歌隊' }, effects: [{ stat: 'atk', op: 'mul', value: 1.12 }] }] },
  dawnblade: { id: 'dawnblade', name: '曙光劍士', element: 'light', class: 'dps', attackStyle: 'melee', race: '人', series: ['光輝'], base: { hp: 510, atk: 94, def: 42 }, growth: { hp: 56, atk: 11, def: 4 }, passives: [{ when: { alliesAtLeast: { count: 2, where: { series: '光輝' } } }, target: 'self', effects: [{ stat: 'atk', op: 'mul', value: 1.2 }] }] },
  ...
  gravewarden: { id: 'gravewarden', name: '幽冥守墓人', element: 'dark', class: 'tank', attackStyle: 'melee', race: '不死', series: ['影之眷屬', '守護者'], base: { hp: 720, atk: 62, def: 72 }, growth: { hp: 82, atk: 6, def: 7 }, passives: [{ target: 'allAllies', targetWhere: { race: '不死' }, effects: [{ stat: 'def', op: 'mul', value: 1.15 }] }] },
  ...
  ashpriest: { id: 'ashpriest', name: '餘燼祭司', element: 'fire', class: 'support', attackStyle: 'ranged', race: '人', series: ['燼火', '聖歌隊'], base: { hp: 505, atk: 72, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '燼火' }, effects: [{ stat: 'atk', op: 'mul', value: 1.12 }] }] },
  magmaturtle: { id: 'magmaturtle', onEnter: { weather: 'sunny' }, name: '熔殼巨龜', element: 'fire', class: 'tank', attackStyle: 'melee', race: '獸', series: ['守護者'], base: { hp: 750, atk: 56, def: 76 }, growth: { hp: 85, atk: 5, def: 8 }, passives: [{ when: { selfHpBelow: 0.4 }, target: 'self', effects: [{ stat: 'def', op: 'mul', value: 1.4 }] }] },
  ...
  emberwitch: { id: 'emberwitch', name: '燼火魔女', element: 'fire', class: 'dps', attackStyle: 'ranged', race: '人', series: ['燼火'], base: { hp: 480, atk: 97, def: 35 }, growth: { hp: 52, atk: 11, def: 3 }, passives: [{ target: 'self', effects: [{ stat: 'dmgDealt', op: 'mul', basePct: 0.06, perCountOf: { side: 'enemies', where: { element: 'wind' } } }] }] },
  ...
  redlion: { id: 'redlion', name: '赤獅騎士', element: 'fire', class: 'tank', attackStyle: 'melee', race: '人', series: ['鐵壁'], base: { hp: 705, atk: 62, def: 70 }, growth: { hp: 79, atk: 6, def: 7 }, passives: [{ when: { alliesAtLeast: { count: 2, where: { series: '鐵壁' } } }, target: 'self', effects: [{ stat: 'dmgTaken', op: 'mul', value: 0.85 }] }] },
  ...
  galeninja: { id: 'galeninja', name: '風隱忍者', element: 'wind', class: 'dps', attackStyle: 'melee', race: '人', series: ['疾風'], base: { hp: 470, atk: 95, def: 34 }, growth: { hp: 50, atk: 11, def: 3 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.03, perCountOf: { side: 'allies', where: { class: 'dps' } } }] }] },
  ...
  windsister: { id: 'windsister', name: '風之雙子', element: 'wind', class: 'support', attackStyle: 'ranged', race: '精靈', series: ['星詠'], base: { hp: 500, atk: 71, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { race: '精靈' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.15 }] }] },
  thundertotem: { id: 'thundertotem', onEnter: { terrain: 'surge' }, name: '雷圖騰師', element: 'wind', class: 'support', attackStyle: 'ranged', race: '獸', series: ['大地'], base: { hp: 515, atk: 74, def: 45 }, growth: { hp: 57, atk: 8, def: 4 }, passives: [{ target: 'allEnemies', effects: [{ stat: 'def', op: 'mul', value: 0.95 }] }] },
  skylancer: { id: 'skylancer', onEnter: { weather: 'gale' }, name: '天嵐槍騎', element: 'wind', class: 'dps', attackStyle: 'melee', race: '龍', series: ['蒼雷'], base: { hp: 520, atk: 92, def: 42 }, growth: { hp: 56, atk: 11, def: 4 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.08, perCountOf: { side: 'allies', where: { race: '龍' } } }] }] },
  ...
  tidesinger: { id: 'tidesinger', name: '潮音歌者', element: 'water', class: 'support', attackStyle: 'ranged', race: '人', series: ['潮汐', '星詠'], base: { hp: 510, atk: 73, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '潮汐' }, effects: [{ stat: 'dmgTaken', op: 'mul', value: 0.94 }] }] },
  glacierknight: { id: 'glacierknight', name: '冰川重騎', element: 'water', class: 'tank', attackStyle: 'melee', race: '人', series: ['霜語', '鐵壁'], base: { hp: 745, atk: 57, def: 75 }, growth: { hp: 84, atk: 5, def: 8 }, passives: [{ when: { alliesAtLeast: { count: 2, where: { series: '霜語' } } }, target: 'allAllies', effects: [{ stat: 'def', op: 'mul', value: 1.06 }] }] },
  ...
  coralshaman: { id: 'coralshaman', name: '珊瑚祭巫', element: 'water', class: 'support', attackStyle: 'ranged', race: '獸', series: ['潮汐'], base: { hp: 520, atk: 72, def: 46 }, growth: { hp: 57, atk: 8, def: 5 }, passives: [{ target: 'allAllies', targetWhere: { race: '獸' }, effects: [{ stat: 'atk', op: 'mul', value: 1.12 }] }] },
  leviathan: { id: 'leviathan', onEnter: { weather: 'rain' }, name: '滄海巨蛇', element: 'water', class: 'dps', attackStyle: 'melee', race: '龍', series: ['深淵', '潮汐'], base: { hp: 530, atk: 91, def: 43 }, growth: { hp: 57, atk: 11, def: 4 }, passives: [{ when: { selfHpBelow: 0.6 }, target: 'self', effects: [{ stat: 'dmgDealt', op: 'mul', value: 1.15 }] }] },
  pearlguard: { id: 'pearlguard', name: '珠貝衛士', element: 'water', class: 'tank', attackStyle: 'melee', race: '機械', series: ['潮汐', '守護者'], base: { hp: 730, atk: 59, def: 73 }, growth: { hp: 82, atk: 6, def: 7 }, passives: [{ target: 'allAllies', targetWhere: { race: '機械' }, effects: [{ stat: 'dmgTaken', op: 'mul', value: 0.9 }] }] },
  ...
  lightweaver: { id: 'lightweaver', name: '織光晶靈', element: 'light', class: 'support', attackStyle: 'ranged', race: '精靈', series: ['星詠', '光輝'], base: { hp: 495, atk: 70, def: 42 }, growth: { hp: 54, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '星詠' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.15 }] }] },
  suninquisitor: { id: 'suninquisitor', name: '燦陽審判官', element: 'light', class: 'dps', attackStyle: 'melee', race: '人', series: ['光輝'], base: { hp: 505, atk: 96, def: 40 }, growth: { hp: 54, atk: 11, def: 4 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.08, perCountOf: { side: 'enemies', where: { race: '不死' } } }] }] },
  ...
  holyfencer: { id: 'holyfencer', name: '聖銀劍士', element: 'light', class: 'dps', attackStyle: 'melee', race: '人', series: ['光輝'], base: { hp: 500, atk: 94, def: 40 }, growth: { hp: 54, atk: 11, def: 4 }, passives: [{ when: { alliesAtLeast: { count: 2, where: { series: '光輝' } } }, target: 'self', effects: [{ stat: 'critChance', op: 'add', value: 0.1 }] }] },
  lumenfox: { id: 'lumenfox', name: '流光靈狐', element: 'light', class: 'support', attackStyle: 'ranged', race: '妖', series: ['星詠'], base: { hp: 505, atk: 74, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { element: 'light' }, effects: [{ stat: 'atk', op: 'mul', value: 1.12 }] }] },
  ...
  shadowpriest: { id: 'shadowpriest', name: '暗影祭司', element: 'dark', class: 'support', attackStyle: 'ranged', race: '人', series: ['深淵'], base: { hp: 500, atk: 72, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '深淵' }, effects: [{ stat: 'atk', op: 'mul', value: 1.12 }] }] },
  boneknight: { id: 'boneknight', onEnter: { terrain: 'erosion' }, name: '白骨騎士', element: 'dark', class: 'tank', attackStyle: 'melee', race: '不死', series: ['影之眷屬', '鐵壁'], base: { hp: 725, atk: 61, def: 71 }, growth: { hp: 81, atk: 6, def: 7 }, passives: [{ when: { selfHpBelow: 0.35 }, target: 'self', effects: [{ stat: 'dmgTaken', op: 'mul', value: 0.8 }] }] },
  nightmare: { id: 'nightmare', name: '夢魘', element: 'dark', class: 'dps', attackStyle: 'melee', race: '妖', series: ['深淵'], base: { hp: 490, atk: 99, def: 35 }, growth: { hp: 52, atk: 12, def: 3 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.06, perCountOf: { side: 'allies', where: { race: '妖' } } }] }] },
