...
export const CARDS = {
  ...
  emberwitch: { id: 'emberwitch', name: '燼火魔女', element: 'fire', class: 'dps', attackStyle: 'ranged', race: '人', series: ['燼火'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } },
  ...
  zephyrmonk: { id: 'zephyrmonk', name: '迅風武僧', element: 'wind', class: 'dps', attackStyle: 'melee', race: '人', series: ['疾風'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } },
