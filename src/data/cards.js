...
export const CARDS = {
  ...
  emberguard: { id: 'emberguard', name: '熔岩守衛', element: 'fire', class: 'tank', attackStyle: 'melee', race: '機械', series: ['炎之眷屬', '守護者'], base: { hp: 700, atk: 60, def: 70 }, growth: { hp: 80, atk: 6, def: 7 }, passives: [{ target: 'allAllies', targetWhere: { series: '守護者' }, effects: [{ stat: 'def', op: 'mul', value: 1.12 }] }] },
  ...
  galewind: { id: 'galewind', name: '風語祭司', element: 'wind', class: 'support', attackStyle: 'ranged', race: '人', series: ['疾風', '聖歌隊'], base: { hp: 500, atk: 70, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { element: 'wind' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.1 }] }] },
  ...
  // ---- 光 ----
  seraph: { id: 'seraph', name: '聖光天使', element: 'light', class: 'support', attackStyle: 'ranged', race: '神', series: ['聖歌隊', '光輝'], base: { hp: 520, atk: 74, def: 46 }, growth: { hp: 58, atk: 8, def: 5 }, passives: [{ target: 'allAllies', targetWhere: { series: '聖歌隊' }, effects: [{ stat: 'atk', op: 'mul', value: 1.1 }] }] },
  ...
  gravewarden: { id: 'gravewarden', name: '幽冥守墓人', element: 'dark', class: 'tank', attackStyle: 'melee', race: '不死', series: ['影之眷屬', '守護者'], base: { hp: 720, atk: 62, def: 72 }, growth: { hp: 82, atk: 6, def: 7 }, passives: [{ target: 'allAllies', targetWhere: { race: '不死' }, effects: [{ stat: 'def', op: 'mul', value: 1.12 }] }] },
  ...
  ashpriest: { id: 'ashpriest', name: '餘燼祭司', element: 'fire', class: 'support', attackStyle: 'ranged', race: '人', series: ['燼火', '聖歌隊'], base: { hp: 505, atk: 72, def: 44 }, growth: { hp: 56, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '燼火' }, effects: [{ stat: 'atk', op: 'mul', value: 1.1 }] }] },
  ...
  windsister: { id: 'windsister', name: '風之雙子', element: 'wind', class: 'support', attackStyle: 'ranged', race: '精靈', series: ['星詠'], base: { hp: 500, atk: 71, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { race: '精靈' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.12 }] }] },
  ...
  skylancer: { id: 'skylancer', name: '天嵐槍騎', element: 'wind', class: 'dps', attackStyle: 'melee', race: '龍', series: ['蒼雷'], base: { hp: 520, atk: 92, def: 42 }, growth: { hp: 56, atk: 11, def: 4 }, passives: [{ target: 'self', effects: [{ stat: 'atk', op: 'mul', basePct: 0.08, perCountOf: { side: 'allies', where: { race: '龍' } } }] }] },
  ...
  lightweaver: { id: 'lightweaver', name: '織光晶靈', element: 'light', class: 'support', attackStyle: 'ranged', race: '精靈', series: ['星詠', '光輝'], base: { hp: 495, atk: 70, def: 42 }, growth: { hp: 54, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '星詠' }, effects: [{ stat: 'energyGain', op: 'mul', value: 1.1 }] }] },
  ...
  lumenfox: { id: 'lumenfox', name: '流光靈狐', element: 'light', class: 'support', attackStyle: 'ranged', race: '妖', series: ['星詠'], base: { hp: 505, atk: 74, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { element: 'light' }, effects: [{ stat: 'atk', op: 'mul', value: 1.08 }] }] },
  ...
  shadowpriest: { id: 'shadowpriest', name: '暗影祭司', element: 'dark', class: 'support', attackStyle: 'ranged', race: '人', series: ['深淵'], base: { hp: 500, atk: 72, def: 43 }, growth: { hp: 55, atk: 8, def: 4 }, passives: [{ target: 'allAllies', targetWhere: { series: '深淵' }, effects: [{ stat: 'atk', op: 'mul', value: 1.1 }] }] },
