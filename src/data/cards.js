...
export const CARDS = {
  ...
  zephyrmonk: { id: 'zephyrmonk', name: '迅風武僧', element: 'wind', class: 'dps', attackStyle: 'melee', basicAttack: { hits: 2, mult: 0.6 }, race: '人', series: ['疾風'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } },
  ...
  abysshunter: { id: 'abysshunter', name: '深淵獵手', element: 'water', class: 'dps', attackStyle: 'melee', race: '妖', series: ['深淵'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } },
