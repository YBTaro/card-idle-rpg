...
export const CARDS = {
  ...
  emberwitch: { id: 'emberwitch', name: '燼火魔女', element: 'fire', class: 'dps', attackStyle: 'ranged', basicAttack: { splash: 0.35 }, race: '人', series: ['燼火'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } },
