...
export const CARDS = {
  ...
  emberwitch: { id: 'emberwitch', name: '燼火魔女', element: 'fire', class: 'dps', attackStyle: 'ranged', race: '人', series: ['燼火'], onEnter: { effects: [{ type: 'energy', amount: 50, scope: 'allAllies', where: { series: '燼火' } }] }, base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } }, // 定位：引爆燃燒法師——進場給燼火隊友起手能量、絕技「爆燃」全體引爆灼燒
  ...
  redlion: { id: 'redlion', name: '赤獅騎士', element: 'fire', class: 'tank', attackStyle: 'melee', race: '人', series: ['鐵壁'], onEnter: { effects: [{ type: 'shield', power: 2.0, duration: 3, scope: 'allAllies', where: { element: 'fire' } }] }, base: { hp: 730, atk: 58, def: 73 }, growth: { hp: 82, atk: 6, def: 8 } }, // 進場技：為火屬隊友張開 200% 攻擊力護盾（持續 3 回合，火隊開局壁壘）
