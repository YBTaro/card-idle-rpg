...
export const CARDS = {
  ...
  emberwitch: { id: 'emberwitch', name: '燼火魔女', element: 'fire', class: 'dps', attackStyle: 'ranged', race: '人', series: ['燼火'], base: { hp: 495, atk: 95, def: 38 }, growth: { hp: 54, atk: 11, def: 4 } }, // 定位：引爆燃燒法師——絕技「爆燃」引爆敵人身上的灼燒（每跳×剩餘回合一次結算）再點新火
