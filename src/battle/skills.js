...
export const SKILLS = {
  ...
  infernoNova: { name: '焚天', target: 'enemyFrontRow', effects: [
    ...
    { type: 'dot', power: 0.45, element: 'fire', duration: 3, scope: 'target' }, // 灼燒：每跳 45%、持續 3 回合
  ]},
  ...
  detonate: { name: '爆燃', target: 'allEnemies', effects: [ // 定位：全體引爆燃燒
    ...
    { type: 'dot', power: 0.45, element: 'fire', duration: 3, scope: 'backEnemies', chance: 0.7 }, // 70% 對後排點新火（每跳 45%、持續 3 回合）
  ]},
