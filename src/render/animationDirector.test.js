...
describe('AnimationDirector', () => {
  ...
  it('DELAYS 精確值', () => {
    expect(DELAYS).toEqual({
      ...
      weather: 1.25, terrain: 1.25, drain: 0.12, enter: 0.7, miss: 0.22, steal: 0.3, shield: 0.15, trigger: 0.25, resist: 0.2, blocked: 0.22, cheated: 0.4, bossPhase: 0.8, bossBreak: 0.5, bossEnrage: 0.8,
    });
  });
});
